...
class TRIZTranslations:
    ...
    TEXTS = {
        "en": {
            ...
            "about_triz_title": "About TRIZ Theory",
            "about_triz_desc": "TRIZ is the Theory of Inventive Problem Solving created by Soviet inventor Altshuller. By analyzing technical contradictions in patent databases, it summarizes 40 innovation principles and contradiction matrix, providing systematic methodology for technical innovation. This platform combines AI technology to make TRIZ theory application more intelligent and convenient.",
            "stat_principles": "Innovation Principles",
            "stat_matrix": "Contradiction Matrix",
            "stat_ai": "AI Analysis",
            "core_advantages_title": "Core Advantages",
            "feature_ai_title": "AI Smart Analysis",
            "feature_ai_desc": "Based on natural language processing technology, automatically identify technical parameters and contradiction relationships",
            "feature_fast_title": "Fast Generation",
            "feature_fast_desc": "Second-level response, quickly generate multiple innovative solutions, improve problem-solving efficiency",
            "feature_database_title": "Complete Principle Library",
            "feature_database_desc": "Contains detailed descriptions, application cases and implementation guidelines for 40 TRIZ principles",
            "feature_scoring_title": "Smart Scoring",
            "feature_scoring_desc": "Dual scoring system for confidence and relevance, quantifying solution quality",
            "feature_export_title": "Result Export",
            "feature_export_desc": "Support JSON and text format export, convenient for subsequent analysis and sharing",
        ...
        "zh": {
            ...
            "footer_version": "Version 1.0",
            "footer_powered": "Powered by TRIZ Theory & AI",
            "about_triz_title": "关于TRIZ理论",
            "about_triz_desc": "TRIZ是由苏联发明家阿奇舒勒创立的发明问题解决理论，通过分析专利数据库中的技术矛盾，总结出40个创新原理和矛盾矩阵，为技术创新提供系统性方法论。本平台结合AI技术，让TRIZ理论的应用更加智能化和便捷化。",
            "stat_principles": "创新原理",
            "stat_matrix": "矛盾矩阵",
            "stat_ai": "智能分析",
            "core_advantages_title": "核心优势",
            "feature_ai_title": "AI智能分析",
            "feature_ai_desc": "基于自然语言处理技术，自动识别技术参数和矛盾关系",
            "feature_fast_title": "快速生成",
            "feature_fast_desc": "秒级响应，快速生成多个创新解决方案，提升问题解决效率",
            "feature_database_title": "完整原理库",
            "feature_database_desc": "包含40个TRIZ原理的详细说明、应用案例和实施指南",
            "feature_scoring_title": "智能评分",
            "feature_scoring_desc": "置信度和相关性双重评分体系，量化解决方案质量",
            "feature_export_title": "结果导出",
            "feature_export_desc": "支持JSON和文本格式导出，便于后续分析和分享",
