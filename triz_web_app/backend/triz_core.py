...
class TRIZTranslations:
    ...
    TEXTS = {
        "en": {
            ...
            "feature_bilingual_desc": "Complete Chinese-English bilingual interface, supporting international application scenarios",
        ...
        "zh": {
            ...
            "stat_matrix": "矛盾矩阵",
            "stat_ai": "智能分析",
            "tech_features_title": "技术特点",
            "feature_ai_title": "AI智能分析",
            "feature_ai_desc": "基于自然语言处理技术，自动识别技术参数和矛盾关系",
            "feature_bilingual_title": "双语支持",
            "feature_bilingual_desc": "完整的中英文双语界面，支持国际化应用场景",
